...
public interface IndexedUnsortedList<T> extends Iterable<T> {
    ...
    /**
     * Unions the current list with the given list.
     * @param list - Given list
     */
    default void union(IndexedUnsortedList<T> list) {
        throw new UnsupportedOperationException("Implement union method");
    }

    /**
     * Changes the current list to ONLY include elements found BOTH in the current list and the given list.
     * @param list - Given list
     */
    default void intersect(IndexedUnsortedList<T> list) {
        throw new UnsupportedOperationException("Implement intersect method");
    }

    /**
     * Changes the current list to include elements that are present in the given list but MISSING from the current list
     * @param list - Given list
     */
    default void difference(IndexedUnsortedList<T> list) {
        throw new UnsupportedOperationException("Implement difference method");
    }

    /**
     * Returns a new list that is the union of the current list and the given list.
     * @param list - Given list
     * @return a new list that is the union of the current list and the given list
     */
    default IndexedUnsortedList<T> getUnion(IndexedUnsortedList<T> list) {
        throw new UnsupportedOperationException("Implement getUnion method");
    }

    /**
    * Returns a new list that is the intersection of the current list and the given list.
    * @param list - Given list
    * @return a new list that is the intersection of the current list and the given list
    */
    default IndexedUnsortedList<T> getIntersect(IndexedUnsortedList<T> list) {
        throw new UnsupportedOperationException("Implement getIntersect method");
    }

    /**
     * Returns a new list that is the difference of the current list and the given list.
     * @param list - Given list
     * @return a new list that is the difference of the current list and the given list
     */
    default IndexedUnsortedList<T> getDifference(IndexedUnsortedList<T> list) {
        throw new UnsupportedOperationException("Implement getDifference method");
    }
}
